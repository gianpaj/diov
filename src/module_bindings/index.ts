...
const tablesSchema = __schema({
  knibble: __table({
    ...
    constraints: [
      { name: 'knibble_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, KnibbleRow),
  player: __table({
    name: 'player',
  ...
  spitBlob: __table({
    ...
    constraints: [
      { name: 'spit_blob_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, SpitBlobRow),
});
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("spit", SpitReducer),
  __reducerSchema("split", SplitReducer),
