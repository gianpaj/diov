...
import type { CanonicalActionV1, PolicyObservationV1, PrivilegedDiagnosticsV1 } from '../schema.ts'
import {
...
export const decodePrivilegedDiagnosticsV1 = (
  payload: Uint8Array
): PrivilegedDiagnosticsV1 => privilegedDiagnosticsV1Schema.parse(decode(payload))
